...
const schema = z.object({
  ...
  containerTypeId: z.union([z.number(), z.string()]),
  carrierId: z.union([z.number(), z.string()]),
  salesAgentId: z.union([z.number(), z.string()]),
  jci: z.string().trim().min(1, "JCI je obavezan."),
  manipulation: z.string().optional().nullable(),
